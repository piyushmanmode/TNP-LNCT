 ...
 */
?>
<?php if( get_theme_mod( 'ecommerce_hub_hide_scroll',true) != '' || get_theme_mod( 'ecommerce_hub_backtotop_responsive',true) != '') { ?>
...
<footer role="contentinfo" id="footer" class="copyright-wrapper">
  ...
  ?>
  <?php if (get_theme_mod('ecommerce_hub_footer_hide_show', true)){ ?>
    <div class="container">
  ...
  <?php } ?>  
  <?php if (get_theme_mod('ecommerce_hub_copyright_hide_show', true)) {?>
    <div class="inner">
      <div class="container">
        <div class="copyright">
