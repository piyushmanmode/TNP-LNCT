				...
				<div class="col-lg-4 col-md-4">
					<article class="blog-sec p-2 mb-4">
					    ...
					    <?php if(get_the_excerpt()) { ?>
					        <div class="entry-content"><p><?php $ecommerce_hub_excerpt = get_the_excerpt(); echo esc_html( ecommerce_hub_string_limit_words( $ecommerce_hub_excerpt, esc_attr(get_theme_mod('ecommerce_hub_related_post_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('ecommerce_hub_button_excerpt_suffix','...') ); ?></p></div>
					    <?php }?>
