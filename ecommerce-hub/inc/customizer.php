...
function ecommerce_hub_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('ecommerce_hub_menu_padding',array(
		'default'=> 20,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_WP_Customize_Range_Control( $wp_customize,'ecommerce_hub_menu_padding',array(
		'label'	=> __('Menu Font Padding','ecommerce-hub'),
		'section'=> 'ecommerce_hub_header',
		'input_attrs' => array(
         'step'  => 1,
			'min'   => 0,
	...
	$wp_customize->add_setting('ecommerce_hub_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_menu_color', array(
		'label'    => __('Menu Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_header',
		'settings' => 'ecommerce_hub_menu_color',
	)));

	$wp_customize->add_setting('ecommerce_hub_menu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_menu_hover_color', array(
		'label'    => __('Menu Hover Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_header',
		'settings' => 'ecommerce_hub_menu_hover_color',
	)));

	$wp_customize->add_setting('ecommerce_hub_submenu_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_submenu_menu_color', array(
		'label'    => __('Submenu Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_header',
		'settings' => 'ecommerce_hub_submenu_menu_color',
	)));

	$wp_customize->add_setting('ecommerce_hub_submenu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_submenu_hover_color', array(
		'label'    => __('Submenu Hover Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_header',
		'settings' => 'ecommerce_hub_submenu_hover_color',
	)));

	$wp_customize->add_setting( 'ecommerce_hub_menu_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('ecommerce_hub_menu_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>". esc_html('Premium Theme Features!','ecommerce-hub') ."</h3>
            <ul>
                <li>". esc_html('Menu DropDown Background Colors','ecommerce-hub') ."</li>
                <li>". esc_html('Menu Item Fonts','ecommerce-hub') ."</li>
                <li>". esc_html('Active Menu Colors','ecommerce-hub') ."</li>
                <li>". esc_html('Header Search Icons Colors','ecommerce-hub') ."</li>
                <li>". esc_html('... and Other Premium Features','ecommerce-hub') ."</li>
            </ul>
            <a target='_blank' href='". esc_url('https://www.themesglance.com/products/wordpress-ecommerce-theme') ." '>". esc_html('Upgrade Now','ecommerce-hub') ."</a>",
        'section' => 'ecommerce_hub_header'
        )
    );
	...
	$wp_customize->add_setting( 'ecommerce_hub_slider_small_title', array(
        'default'           => '',
        'sanitize_callback' => 'sanitize_text_field'
    ) );
    $wp_customize->add_control( 'ecommerce_hub_slider_small_title', array(
        'label'    => __( 'Add Slider Small Text', 'ecommerce-hub' ),
        'input_attrs' => array(
            'placeholder' => __( '2018', 'ecommerce-hub' ),
        ),
        'section'  => 'ecommerce_hub_slider_section',
        'type'     => 'text'
    ) );
	...
	$wp_customize->add_setting( 'ecommerce_hub_slider_arrow_hide_show',array(
	    'default' => true,   
	    'sanitize_callback' => 'ecommerce_hub_sanitize_checkbox'
	));
	$wp_customize->add_control( 'ecommerce_hub_slider_arrow_hide_show',array(
		'label' => esc_html__( 'Show / Hide Slider Arrows','ecommerce-hub' ),
		'section' => 'ecommerce_hub_slider_section',
		'type' => 'checkbox',
	));

	$wp_customize->add_setting('ecommerce_hub_slider_prev_icon',array(
		'default'	=> 'fas fa-chevron-left',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new ecommerce_hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_slider_prev_icon',array(
		'label'	=>__('Add Slider Prev Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_slider_section',
		'setting'	=> 'ecommerce_hub_slider_prev_icon',
		'type'		=> 'icon',
	)));

	$wp_customize->add_setting('ecommerce_hub_slider_next_icon',array(
		'default'	=> 'fas fa-chevron-right',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new ecommerce_hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_slider_next_icon',array(
		'label'	=> __('Add Slider Next Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_slider_section',
		'setting'	=> 'ecommerce_hub_slider_next_icon',
		'type'		=> 'icon',
	)));

	 $wp_customize->add_setting('ecommerce_hub_slider_arrows_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_slider_arrows_hover_color', array(
		'label'    => __('Slider Arrows hover Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_slider_section',
		'settings' => 'ecommerce_hub_slider_arrows_hover_color',
	)));
	...
	$wp_customize->add_setting('ecommerce_hub_slider_button_link',array(
        'default'=> '',
        'sanitize_callback' => 'esc_url_raw'
    ));
    $wp_customize->add_control('ecommerce_hub_slider_button_link',array(
        'label' => esc_html__('Add Button Link','ecommerce-hub'),
        'section'=> 'ecommerce_hub_slider_section',
        'type'=> 'url'
    ));

	$wp_customize->add_setting('ecommerce_hub_slider_btn_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_slider_btn_color', array(
		'label'    => __('Slider Button Lable Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_slider_section',
		'settings' => 'ecommerce_hub_slider_btn_color',
	)));

	$wp_customize->add_setting('ecommerce_hub_slider_btn_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_slider_btn_bg_color', array(
		'label'    => __('Slider Button Bg Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_slider_section',
		'settings' => 'ecommerce_hub_slider_btn_bg_color',
	)));

    $wp_customize->add_setting('ecommerce_hub_slider_btn_lable_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_slider_btn_lable_hover_color', array(
		'label'    => __('Slider Button Lable hover Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_slider_section',
		'settings' => 'ecommerce_hub_slider_btn_lable_hover_color',
	)));

	$wp_customize->add_setting('ecommerce_hub_slider_btn_bg_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_slider_btn_bg_hover_color', array(
		'label'    => __('Slider Button Bg hover Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_slider_section',
		'settings' => 'ecommerce_hub_slider_btn_bg_hover_color',
	)));
    ...
    $wp_customize->add_setting( 'ecommerce_hub_product_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('ecommerce_hub_product_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>". esc_html('Premium Theme Features!','ecommerce-hub') ."</h3>
            <ul>
                <li>". esc_html('Title Font & Color Settings','ecommerce-hub') ."</li>
                <li>". esc_html('Background Image Settings','ecommerce-hub') ."</li>
                <li>". esc_html('... and Other Premium Features','ecommerce-hub') ."</li>
            </ul>
            <a target='_blank' href='". esc_url('https://www.themesglance.com/products/wordpress-ecommerce-theme') ." '>". esc_html('Upgrade Now','ecommerce-hub') ."</a>",
        'section' => 'ecommerce_hub_featured_products'
	...
	$wp_customize->add_setting('ecommerce_hub_blog_post_alignment',array(
        'default' => 'left',
        'sanitize_callback' => 'ecommerce_hub_sanitize_choices'
    ));
	$wp_customize->add_control('ecommerce_hub_blog_post_alignment', array(
        'type' => 'select',
        'label' => __( 'Blog Post Alignment', 'ecommerce-hub' ),
        'section' => 'ecommerce_hub_theme_layout',
        'choices' => array(
            'left' => __('Left Align','ecommerce-hub'),
            'right' => __('Right Align','ecommerce-hub'),
            'center' => __('Center Align','ecommerce-hub')
        ),
    ));
    ...
    $wp_customize->add_setting('ecommerce_hub_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_theme_layout',
		'setting'	=> 'ecommerce_hub_postdate_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('ecommerce_hub_postauthor_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_postauthor_icon',array(
		'label'	=> __('Add Post Author Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('ecommerce_hub_postcomment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_postcomment_icon',array(
		'label'	=> __('Add Post Comments Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('ecommerce_hub_posttime_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_posttime_icon',array(
		'label'	=> __('Add Post Time Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_theme_layout',
		'type'		=> 'icon'
	)));
	...
	//Featured Image
	$wp_customize->add_setting('ecommerce_hub_blog_image_dimension',array(
       'default' => 'default',
       'sanitize_callback'	=> 'ecommerce_hub_sanitize_choices'
    ));
    $wp_customize->add_control('ecommerce_hub_blog_image_dimension',array(
       'type' => 'radio',
       'label'	=> __('Blog Post Featured Image Dimension','ecommerce-hub'),
       'choices' => array(
            'default' => __('Default','ecommerce-hub'),
            'custom' => __('Custom Image Size','ecommerce-hub'),
        ),
      	'section'	=> 'ecommerce_hub_theme_layout',
    ));

    $wp_customize->add_setting( 'ecommerce_hub_feature_image_custom_width', array(
		'default'=> '250',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( new Ecommerce_Hub_WP_Customize_Range_Control( $wp_customize, 'ecommerce_hub_feature_image_custom_width', array(
        'label'  => __('Featured Image Custom Width','ecommerce-hub'),
        'section'  => 'ecommerce_hub_theme_layout',
        'description' => __('Measurement is in pixel.','ecommerce-hub'),
        'input_attrs' => array(
            'min' => 0,
		...
		'active_callback' => 'ecommerce_hub_blog_image_dimension'
    )));

    $wp_customize->add_setting( 'ecommerce_hub_feature_image_custom_height', array(
		'default'=> '250',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( new Ecommerce_Hub_WP_Customize_Range_Control( $wp_customize, 'ecommerce_hub_feature_image_custom_height', array(
        'label'  => __('Featured Image Custom Height','ecommerce-hub'),
        'section'  => 'ecommerce_hub_theme_layout',
        'description' => __('Measurement is in pixel.','ecommerce-hub'),
        'input_attrs' => array(
            'min' => 0,
    ...
    $wp_customize->add_setting( 'ecommerce_hub_post_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('ecommerce_hub_post_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>". esc_html('Premium Theme Features!','ecommerce-hub') ."</h3>
            <ul>
                <li>". esc_html('Section Heading Option','ecommerce-hub') ."</li>
                <li>". esc_html('Animated Elements Colors','ecommerce-hub') ."</li>
                <li>". esc_html('... and Other Premium Features','ecommerce-hub') ."</li>
            </ul>
            <a target='_blank' href='". esc_url('https://www.themesglance.com/products/wordpress-ecommerce-theme') ." '>". esc_html('Upgrade Now','ecommerce-hub') ."</a>",
        'section' => 'ecommerce_hub_theme_layout'
    ...
    $wp_customize->add_setting('ecommerce_hub_singlepost_date_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_singlepost_date_icon',array(
		'label'	=> __('Add Single Post Date Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_single_post_settings',
		'setting'	=> 'ecommerce_hub_singlepost_date_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('ecommerce_hub_singlepost_author_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_singlepost_author_icon',array(
		'label'	=> __('Add Single Post Author Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('ecommerce_hub_single_post_comment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_single_post_comment_icon',array(
		'label'	=> __('Add Single Post Comments Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('ecommerce_hub_single_post_time_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Ecommerce_Hub_Icon_Selector(
        $wp_customize,'ecommerce_hub_single_post_time_icon',array(
		'label'	=> __('Add Single Post Time Icon','ecommerce-hub'),
		'transport' => 'refresh',
		'section'	=> 'ecommerce_hub_single_post_settings',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('ecommerce_hub_single_post_metabox_seperator',array(
       'default' => '|',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('ecommerce_hub_single_post_metabox_seperator',array(
       'type' => 'text',
       'label' => __('Metabox Seperator','ecommerce-hub'),
       'description' => __('Ex: "/", "|", "-", ...','ecommerce-hub'),
       'section' => 'ecommerce_hub_single_post_settings'
    ...
    $wp_customize->add_setting('ecommerce_hub_single_post_category',array(
       'default' => 'true',
       'sanitize_callback'	=> 'ecommerce_hub_sanitize_checkbox'
    ));
    $wp_customize->add_control('ecommerce_hub_single_post_category',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Single Post Category','ecommerce-hub'),
       'section' => 'ecommerce_hub_single_post_settings'
    ));
    ...
    $wp_customize->add_setting( 'ecommerce_hub_single_post_img_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'ecommerce_hub_sanitize_float',
	) );
	$wp_customize->add_control( 'ecommerce_hub_single_post_img_border_radius', array(
		'label'       => esc_html__( 'Single Post Image Border Radius','ecommerce-hub' ),
		'section'     => 'ecommerce_hub_single_post_settings',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'ecommerce_hub_single_post_img_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'ecommerce_hub_sanitize_float',
	));
	$wp_customize->add_control('ecommerce_hub_single_post_img_box_shadow',array(
		'label' => esc_html__( 'Single Post Image Shadow','ecommerce-hub' ),
		'section' => 'ecommerce_hub_single_post_settings',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
    ...
    $wp_customize->add_setting( 'ecommerce_hub_related_post_excerpt_number',array(
		'default' => 20,
		'sanitize_callback' => 'ecommerce_hub_sanitize_float'
	));

	$wp_customize->add_control('ecommerce_hub_related_post_excerpt_number',	array(
		'label' => esc_html__( 'Related Posts Content Limit','ecommerce-hub' ),
		'section' => 'ecommerce_hub_single_post_settings',
		'type'    => 'number',
	 	'settings' => 'ecommerce_hub_related_post_excerpt_number',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
			'step' => 1,
	...
	// Grid layout setting
	$wp_customize->add_section( 'ecommerce_hub_grid_layout_settings', array(
		'title' => __( 'Grid Layout Settings', 'ecommerce-hub' ),
		'panel' => 'ecommerce_hub_panel_id',
	));

	$wp_customize->add_setting('ecommerce_hub_grid_button_text',array(
		'default'=> esc_html__('Read Full','ecommerce-hub'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('ecommerce_hub_grid_button_text',array(
		'label'	=> esc_html__('Add Button Text','ecommerce-hub'),
		'input_attrs' => array(
        'placeholder' => esc_html__( 'Read Full', 'ecommerce-hub' ),
      ),
		'section'=> 'ecommerce_hub_grid_layout_settings',
		'type'=> 'text'
	));

	$wp_customize->add_setting('ecommerce_hub_grid_excerpt_suffix',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('ecommerce_hub_grid_excerpt_suffix',array(
		'label'	=> __('Add Excerpt Suffix','ecommerce-hub'),
		'input_attrs' => array(
            'placeholder' => __( '[...]', 'ecommerce-hub' ),
        ),
		'section'=> 'ecommerce_hub_grid_layout_settings',
		'type'=> 'text'
	));

	$wp_customize->add_setting('ecommerce_hub_grid_post_metabox_seperator',array(
       'default' => '|',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('ecommerce_hub_grid_post_metabox_seperator',array(
       'type' => 'text',
       'label' => __('Metabox Seperator','ecommerce-hub'),
       'description' => __('Ex: "/", "|", "-", ...','ecommerce-hub'),
       'section' => 'ecommerce_hub_grid_layout_settings'
    ...
    // font size button
 	$wp_customize->add_setting( 'ecommerce_hub_button_font_size',array(
		'default' => '16',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control( new ecommerce_hub_WP_Customize_Range_Control( $wp_customize, 'ecommerce_hub_button_font_size', array(
		'label'  => __('Button Font Size','ecommerce-hub'),
		'section'  => 'ecommerce_hub_button_options',
		'description' => __('Measurement is in pixel.','ecommerce-hub'),
		'input_attrs' => array(
		   'min' => 0,
 	...
 	$wp_customize->add_setting('ecommerce_hub_button_font_weight',array(
    'default' => '',
    'sanitize_callback' => 'ecommerce_hub_sanitize_choices'
	));
	$wp_customize->add_control('ecommerce_hub_button_font_weight',array(
	    'type' => 'select',
	    'label' => __('Button Font Weight','ecommerce-hub'),
	    'section' => 'ecommerce_hub_button_options',
	    'choices' => array(
	       '100' => __('100','ecommerce-hub'),
	       '200' => __('200','ecommerce-hub'),
	...
	$wp_customize->add_setting('ecommerce_hub_button_text_transform',array(
        'default' => '',
        'sanitize_callback' => 'ecommerce_hub_sanitize_choices'
  	));
  	$wp_customize->add_control('ecommerce_hub_button_text_transform',array(
        'type' => 'select',
        'label' => __('Button Text transform','ecommerce-hub'),
        'section' => 'ecommerce_hub_button_options',
        'choices' => array(
            'uppercase' => __('Uppercase','ecommerce-hub'),
            'capitalize' => __('Capitalize','ecommerce-hub'),
            'lowercase' => __('lowercase','ecommerce-hub'),
        ),
  	) );
    ...
    $wp_customize->add_setting( 'ecommerce_hub_preloader_color', array(
  	...
  	$wp_customize->add_setting('ecommerce_hub_preloader_bg_img',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'ecommerce_hub_preloader_bg_img',array(
        'label' => __('Preloader Background Image','ecommerce-hub'),
        'section' => 'ecommerce_hub_advance_options'
	)));
	...
	$wp_customize->add_setting( 'ecommerce_hub_single_page_breadcrumb',array(
		'default' => true,
      	'sanitize_callback'	=> 'ecommerce_hub_sanitize_checkbox'
    ) );
    $wp_customize->add_control('ecommerce_hub_single_page_breadcrumb',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Single Page Breadcrumb','ecommerce-hub' ),
        'section' => 'ecommerce_hub_advance_options'
    ));

    $wp_customize->add_setting('ecommerce_hub_breadcrumb_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_breadcrumb_color', array(
		'label'    => __('Breadcrumb Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_advance_options',
	)));

	$wp_customize->add_setting('ecommerce_hub_breadcrumb_background_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_breadcrumb_background_color', array(
		'label'    => __('Breadcrumb Background Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_advance_options',
	)));

	$wp_customize->add_setting('ecommerce_hub_breadcrumb_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_breadcrumb_hover_color', array(
		'label'    => __('Breadcrumb Hover Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_advance_options',
	)));

	$wp_customize->add_setting('ecommerce_hub_breadcrumb_hover_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_breadcrumb_hover_bg_color', array(
		'label'    => __('Breadcrumb Hover Background Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_advance_options',
	)));
    ...
    $wp_customize->add_setting( 'ecommerce_hub_toggle_button_bg_color_settings', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ecommerce_hub_toggle_button_bg_color_settings', array(
  		'label' => __('Toggle Button Bg Color', 'ecommerce-hub'),
	    'section' => 'ecommerce_hub_responsive_options',
	    'settings' => 'ecommerce_hub_toggle_button_bg_color_settings',
  	)));
   
	$wp_customize->add_setting('ecommerce_hub_sticky_header_responsive',array(
        'default' => false,
        'sanitize_callback'	=> 'ecommerce_hub_sanitize_checkbox'
	));
	$wp_customize->add_control('ecommerce_hub_sticky_header_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Sticky Header','ecommerce-hub'),
      	'section' => 'ecommerce_hub_responsive_options',
	));
	...
	$wp_customize->add_setting('ecommerce_hub_slider_responsive',array(
        'default' => true,
        'sanitize_callback'	=> 'ecommerce_hub_sanitize_checkbox'
	));
	$wp_customize->add_control('ecommerce_hub_slider_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Slider','ecommerce-hub'),
      	'section' => 'ecommerce_hub_responsive_options',
	));

	$wp_customize->add_setting('ecommerce_hub_slider_button_responsive',array(
        'default' => true,
        'sanitize_callback'	=> 'ecommerce_hub_sanitize_checkbox'
	));
	$wp_customize->add_control('ecommerce_hub_slider_button_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Slider Button','ecommerce-hub'),
      	'section' => 'ecommerce_hub_responsive_options',
	));
	...
	$wp_customize->add_setting('ecommerce_hub_backtotop_responsive',array(
        'default' => true,
        'sanitize_callback'	=> 'ecommerce_hub_sanitize_checkbox'
	));
	$wp_customize->add_control('ecommerce_hub_backtotop_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Back to Top','ecommerce-hub'),
      	'section' => 'ecommerce_hub_responsive_options',
	));

	$wp_customize->add_setting( 'ecommerce_hub_sidebar_hide_show',array(
      'default' => true,
      'sanitize_callback'	=> 'ecommerce_hub_sanitize_checkbox'
    ));
    $wp_customize->add_control('ecommerce_hub_sidebar_hide_show',array(
      'type' => 'checkbox',
      'label' => esc_html__( 'Enable Sidebar','ecommerce-hub' ),
      'section' => 'ecommerce_hub_responsive_options'
    ));
    ...
    $wp_customize->add_setting('ecommerce_hub_shop_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'ecommerce_hub_sanitize_choices',
	));
	$wp_customize->add_control('ecommerce_hub_shop_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Shop Page Layout', 'ecommerce-hub'),
		'section'        => 'ecommerce_hub_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'ecommerce-hub'),
			'Right Sidebar' => __('Right Sidebar', 'ecommerce-hub'),
    ...
    $wp_customize->add_setting('ecommerce_hub_single_product_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'ecommerce_hub_sanitize_choices',
	));
	$wp_customize->add_control('ecommerce_hub_single_product_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Single Product Page Layout', 'ecommerce-hub'),
		'section'        => 'ecommerce_hub_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'ecommerce-hub'),
			'Right Sidebar' => __('Right Sidebar', 'ecommerce-hub'),
	...
	$wp_customize->add_setting('ecommerce_hub_back_to_top_text_color', array(
		'default'           => '#1b1b1b',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_back_to_top_text_color', array(
		'label'    => __('Back To Top Text Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_footer_section',
	)));

	$wp_customize->add_setting( 'ecommerce_hub_footer_hide_show',array(
      'default' => 'true',
      'sanitize_callback' => 'ecommerce_hub_sanitize_checkbox'
    ));
    $wp_customize->add_control('ecommerce_hub_footer_hide_show',array(
    	'type' => 'checkbox',
      'label' => esc_html__( 'Show / Hide Footer','ecommerce-hub' ),
      'section' => 'ecommerce_hub_footer_section'
    ));
    ...
    $wp_customize->add_setting('ecommerce_hub_widgets_heading_fontsize',array(
		'default'	=> 26,
		'sanitize_callback'	=> 'ecommerce_hub_sanitize_float',
	));	
	$wp_customize->add_control('ecommerce_hub_widgets_heading_fontsize',array(
		'label'	=> __('Footer Widgets Heading Font Size','ecommerce-hub'),
		'section'	=> 'ecommerce_hub_footer_section',
		'type'		=> 'number'
	));

	$wp_customize->add_setting('ecommerce_hub_widgets_heading_font_weight',array(
        'default' => '600',
        'sanitize_callback' => 'ecommerce_hub_sanitize_choices'
    ));
    $wp_customize->add_control('ecommerce_hub_widgets_heading_font_weight',array(
        'type' => 'select',
        'label' => __('Footer Widgets Heading Font Weight','ecommerce-hub'),
        'section' => 'ecommerce_hub_footer_section',
        'choices' => array(
            '100' => __('100','ecommerce-hub'),
            '200' => __('200','ecommerce-hub'),
    ...
    $wp_customize->add_setting('ecommerce_hub_footer_widgets_heading',array(
    'default' => 'Left',
    'transport' => 'refresh',
    'sanitize_callback' => 'ecommerce_hub_sanitize_choices'
	));
	$wp_customize->add_control('ecommerce_hub_footer_widgets_heading',array(
    'type' => 'select',
    'label' => __('Footer Widget Heading Alignment','ecommerce-hub'),
    'section' => 'ecommerce_hub_footer_section',
    'choices' => array(
    	'Left' => __('Left','ecommerce-hub'),
        'Center' => __('Center','ecommerce-hub'),
	...
	$wp_customize->add_setting('ecommerce_hub_footer_widgets_content',array(
    'default' => 'Left',
    'transport' => 'refresh',
    'sanitize_callback' => 'ecommerce_hub_sanitize_choices'
	));
	$wp_customize->add_control('ecommerce_hub_footer_widgets_content',array(
    'type' => 'select',
    'label' => __('Footer Widget Content Alignment','ecommerce-hub'),
    'section' => 'ecommerce_hub_footer_section',
    'choices' => array(
    	'Left' => __('Left','ecommerce-hub'),
        'Center' => __('Center','ecommerce-hub'),
    ...
    $wp_customize->add_setting( 'ecommerce_hub_copyright_hide_show',array(
      'default' => 'true',
      'sanitize_callback' => 'ecommerce_hub_sanitize_checkbox'
    ));
    $wp_customize->add_control('ecommerce_hub_copyright_hide_show',array(
    	'type' => 'checkbox',
      'label' => esc_html__( 'Show / Hide Copyright','ecommerce-hub' ),
      'section' => 'ecommerce_hub_footer_section'
    ));

    $wp_customize->add_setting('ecommerce_hub_copyright_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_copyright_bg_color', array(
		'label'    => __('Copyright Background Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_footer_section',
	)));

	$wp_customize->add_setting('ecommerce_hub_copyright_color', array(
		'default'           => '#1b1b1b',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'ecommerce_hub_copyright_color', array(
		'label'    => __('Copyright Color', 'ecommerce-hub'),
		'section'  => 'ecommerce_hub_footer_section',
	)));
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			...
			'ecommerce_hub_pro_link',
				...
				'pro_text' => esc_html__( 'Get Pro', 'ecommerce-hub' ),
				'pro_url'  => esc_url('https://www.themesglance.com/products/wordpress-ecommerce-theme')
				)
			)
		);
		...
		$manager->add_section(
			new Ecommerce_Hub_Customize_Section_Pro(
			$manager,
			'ecommerce_hub_doc_link',
				array(
				'priority' => 9,
				'title' => esc_html__( 'Ecommerce Hub Doc', 'ecommerce-hub' ),
				'pro_text' => esc_html__( 'Help Doc', 'ecommerce-hub' ),
				'pro_url'  => esc_url(ECOMMERCE_HUB_THEMESGLANCE_FREE_THEME_DOC)
				)
			)
		);
	}
